...
<html lang="en">
    ...
    <head>
        <title>Balando - Shop eCommerce</title>
        <meta charset="utf-8">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                    ...
                    <div class="navbar align-self-center d-flex">
                        ...
                        <a class="nav-icon position-relative text-decoration-none" href="<?=site_url('Cart');?>">
                            <i class="fa fa-fw fa-cart-arrow-down text-dark mr-1"></i>
                            <span class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark">
                                <?php
                                    $db      = \Config\Database::connect();
                                    $ip = $user_ip;
                                    $Query   = "SELECT COUNT(*) as 'Count' FROM cart WHERE ip = '$ip'";
                                    $builder = $db->query($Query);
                                    $getCount  = $builder->getResult();
                                    $getCount = $getCount[0]->Count;
                                    echo $getCount;
                                 ?>
                            </span>
                        </a>
