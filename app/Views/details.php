        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src='<?=base_url("images/products/$product->image")?>' alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src='<?=base_url("images/products/$product->image")?>' alt="Product Image 1">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src='<?=base_url("images/products/$product->image")?>' alt="Product Image 2">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="#">
                                                <img class="card-img img-fluid" src='<?=base_url("images/products/$product->image")?>' alt="Product Image 3">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php endfor; ?>
                                <span class="list-inline-item text-dark">Rating <?=$product->rating?></span>
                            </p>
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?= $product->catName ?></strong></p>
                                </li>
                            </ul>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><?= $product->genderName ?></strong></p>
                                </li>
                            </ul>

                            <h6>Description:</h6>
                            <p><?=$product->description?></p>
                            <form action='<?=site_url("Shop/addToCart/$product->id")?>' method="POST">
